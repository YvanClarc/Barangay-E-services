...
<head>
  ...
  <title>Barangay Residency - Barangay E-Services</title>
  ...
  <section class="service-page">
    <div class="container">
      <div class="service-header">
        ...
        <p class="service-description">Get your residency certificate to prove your residence in the barangay.</p>
      </div>
      ...
      <div class="service-content">
        ...
        <div class="content-card">
          ...
          <ol class="steps-list">
            ...
            <li>Select "Barangay Residency" from the available services</li>
        ...
        <div class="content-card">
          ...
          <p>Barangay residency applications are typically processed within 1-2 business days after submission of complete requirements.</p>
        </div>
