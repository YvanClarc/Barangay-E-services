...
<head>
  ...
  <title>Barangay Clearance - Barangay E-Services</title>
  ...
  <section class="service-page">
    <div class="container">
      <div class="service-header">
        ...
        <p class="service-description">Obtain your barangay clearance certificate for various purposes.</p>
      </div>
      ...
      <div class="service-content">
        ...
        <div class="content-card">
          ...
          <ol class="steps-list">
            ...
            <li>Select "Barangay Clearance" from the available services</li>
        ...
        <div class="content-card">
          ...
          <p>Barangay clearance applications are typically processed within 1-2 business days after submission of complete requirements.</p>
        </div>
