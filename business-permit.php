...
<head>
  ...
  <title>Business Permit - Barangay E-Services</title>
  ...
  <section class="service-page">
    <div class="container">
      <div class="service-header">
        ...
        <p class="service-description">Apply for your business permit online and get it processed efficiently.</p>
      </div>
      ...
      <div class="service-content">
        ...
        <div class="content-card">
          ...
          <ol class="steps-list">
            ...
            <li>Select "Business Permit" from the available services</li>
        ...
        <div class="content-card">
          ...
          <p>Business permit applications are typically processed within 3-5 business days after submission of complete requirements.</p>
        </div>
